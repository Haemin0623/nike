...
public class ProductController {
	...
	public String newReleases(Filter filter, String pageNum, Model model) {
		...
		if (filter.getSearch() != null || filter.getGender() != null || filter.getColor() != null || filter.getPrice() != null || filter.getProductSize() != null || filter.getLarge() != null || filter.getSmall() != null) {
